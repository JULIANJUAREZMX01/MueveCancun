...
> Última actualización: 2026-03-28 · Versión actual: **1.0.0 (Nexus Prime v3.3.1)**
...
- **Motor WASM Multi-módulo (Rust)** — `route-calculator` y `spatial-index` compilados y trackeados en Git para despliegues deterministas.
- **WASM Build Pipeline** — Nexus Signaling, optimizado contra Inyección de Shell y multi-plataforma.
- **FFI Boundary** — Documentación técnica de contratos de datos WASM-TS en `ARCH_MANIFEST.md`.
- **Motor de ruteo** — Detección de transbordos exactos y por proximidad geográfica (≤ 350 m).
...
### Tareas
- [ ] Completar y depurar `public/data/master_routes.json` con rutas reales de Cancún.
...
| Prioridad | Tarea |
|-----------|-------|
| 🔴 | [x] Limpiar artefactos de desarrollo de la raíz |
...
|---------|-------|---------------------|
| v3.3.1 | 2026-03-28 | Soporte WASM multi-módulo; Optimización de build chain; ARCH_MANIFEST; Fix de SyntaxError; Eliminación de artefactos dev |
| v3.3 | 2026-03-10 | Nexus Transfer Engine; GPS → parada; mapa interactivo; balance IndexedDB; 11 test files; 6 workflows CI/CD |
| v3.2 | 2026-02-19 | WasmLoader singleton; SpatialHash; CoordinateFinder 2.1× más rápido |
