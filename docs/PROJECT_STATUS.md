...
**Fecha:** 2026-04-02
**Versión:** 1.2.1 (Nexus Prime v3.3.3)
**Versión:** 1.0.1 (Nexus Prime v3.3.3)
...
| i18n Español / Inglés | ✅ Client-side Redirection (Static) |
...
| Tier 1 Reporting (Offline-First) | ✅ Custom IDB Queue + GitHub API |
