...
async function generateOgImage() {
    ...
    <svg width="${width}" height="${height}" viewBox="0 0 ${width} ${height}" xmlns="http://www.w3.org/2000/svg">
        ...
        <!-- Main Title -->
        <text x="80" y="120" font-family="Arial, sans-serif" font-weight="bold" font-size="80" fill="#ffffff">MueveCancun</text>
        <text x="80" y="200" font-family="Arial, sans-serif" font-weight="bold" font-size="45" fill="#00B4D8">Que ruta me lleva?</text>
        ...
        <text x="80" y="${height - 40}" font-family="Arial, sans-serif" font-size="24" fill="#ffffff">La guia oficial de transporte publico de Cancun</text>
