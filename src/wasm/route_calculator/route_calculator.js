 ...
 * @param {string} from
 * @param {string} to
 * @param {any} _routes_val
 * @returns {any}
 */
export function find_route(from, to, _routes_val) {
    const ptr0 = passStringToWasm0(from, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(to, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.find_route(ptr0, len0, ptr1, len1, _routes_val);
    return ret;
}
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./route_calculator_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('route_calculator_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
